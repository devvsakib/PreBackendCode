...
const WatchedCard = () => {
    ...
    const { watched, deleteAction } = GetMovieList();
    
    return (
        <>
            {
                watched.length == 0 ? <h1 className='text-xl font-semibold mb-5'>No movies in watched list</h1> : watched && watched.map((movie, idx) => (
